...
export const LoginPage: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-slate-100 dark:bg-[#0b0f19] p-4 overflow-hidden text-slate-900 dark:text-slate-100 transition-colors duration-300">
      ...
      <div className="bg-blob-indigo -top-20 -left-20 opacity-50 dark:opacity-40 animate-pulse pointer-events-none" />
      <div className="bg-blob-rose -bottom-20 -right-20 opacity-40 dark:opacity-30 animate-pulse pointer-events-none" />
